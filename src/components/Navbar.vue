...
<template>
    <nav :style="{ backgroundColor: navBackground }">
        ...
        <div class="navlinks-container" :class="{ open: isMenuOpen }">
            <RouterLink to="/work" :class="{ active: $route.path === '/work' }" @click="closeMenu">
                WORK
            </RouterLink>
            <RouterLink to="/about" :class="{ active: $route.path === '/about' }" @click="closeMenu">
                ABOUT
            </RouterLink>
            <RouterLink to="/contact" :class="{ active: $route.path === '/contact' }" @click="closeMenu">
                CONTACT
            </RouterLink>
        </div>
